"""Bounded, immutable contracts for Delphi's numerical pipeline.
...
ALGORITHM_VERSION = "delphi-gbm-v1"
TARGET_VERSION = "delphi-target-v1"
...
class PriceReference(Contract):
    schema_version: Literal[1] = 1
    algorithm_version: Literal["delphi-gbm-v1"] = ALGORITHM_VERSION
...
class TargetSurface(Contract):
    version: Literal["delphi-target-v1"] = TARGET_VERSION
    reference_id: ContentID
    target_id: ContentID
    kind: TargetKind
    axes: Axes
