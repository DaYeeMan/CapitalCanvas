...
from app.delphi.implied_volatility import build_target, invert_price
from app.delphi.models import Market, SamplingRequest, TargetSurface, default_reference_request
...
from delphi_fixtures import small_reference, with_target_data


class DelphiIVTests(unittest.TestCase):
    ...
    def test_ill_conditioned_and_solver_failures_are_explicit(self):
        ...
        with patch("app.delphi.implied_volatility.brentq", side_effect=RuntimeError("no convergence")):
    ...
    def test_iv_cancellation_is_not_swallowed_as_a_mask(self):
        ...
        try:
            with patch("app.delphi.implied_volatility.brentq", side_effect=stopped):
