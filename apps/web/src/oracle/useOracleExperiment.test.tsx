...
async function ready() { const hook = renderHook(useOracleExperiment); await waitFor(() => expect(hook.result.current.capabilities).toBeTruthy()); return hook; }
...
describe("Oracle state and request ownership", () => {
