...
export function OracleParameters({ config, capabilities, edit, referenceStatus }: Props) {
  ...
  return <>
    ...
    <details open className="oracle-control-section" aria-labelledby={`${id}-surface`}>
    ...
    <details open className="oracle-control-section" aria-labelledby={`${id}-reference`}>
    ...
    <details open className="oracle-control-section" aria-labelledby={`${id}-training`}>
